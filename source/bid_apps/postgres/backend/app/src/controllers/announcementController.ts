...
export class AnnouncementController {
  ...
  getList = async (req: Request, res: Response): Promise<void> => {
    logger.info({ query: req.query }, "GET /api/announcements hit");
    ...
    try {
      ...
      logger.info({ count: result.data.length, total: result.total, page: result.page }, "Announcements response");
  ...
  getByNo = async (req: Request, res: Response): Promise<void> => {
    logger.info({ announcementNo: req.params.announcementNo }, "GET /api/announcements/:announcementNo hit");
    ...
    try {
      ...
      logger.error({ err: error, announcementNo }, "ERROR in GET /api/announcements/:announcementNo");
      if (!res.headersSent) {
        res.status(500).json({
          error: "Internal Server Error",
          message: error instanceof Error ? error.message : String(error),
  ...
  getProgressingCompanies = async (req: Request, res: Response): Promise<void> => {
    logger.info({ announcementNo: req.params.announcementNo }, "GET /api/announcements/:announcementNo/progressing-companies hit");
    ...
    try {
      ...
      logger.error({ err: error, announcementNo }, "ERROR in GET /api/announcements/:announcementNo/progressing-companies");
      if (!res.headersSent) {
        res.status(500).json({
          error: "Internal Server Error",
          message: error instanceof Error ? error.message : String(error),
  ...
  getSimilarCases = async (req: Request, res: Response): Promise<void> => {
    logger.info({ announcementNo: req.params.announcementNo }, "GET /api/announcements/:announcementNo/similar-cases hit");
    ...
    try {
      ...
      logger.error({ err: error, announcementNo }, "ERROR in GET /api/announcements/:announcementNo/similar-cases");
      if (!res.headersSent) {
        res.status(500).json({
          error: "Internal Server Error",
          message: error instanceof Error ? error.message : String(error),
  ...
  getDocumentPreview = async (req: Request, res: Response): Promise<void> => {
    ...
    try {
      ...
      logger.error({ err: error, announcementNo, documentId }, "ERROR in GET /api/announcements/:announcementNo/documents/:documentId/preview");
      if (!res.headersSent) {
        res.status(500).json({
          error: "Internal Server Error",
          message: error instanceof Error ? error.message : String(error),
